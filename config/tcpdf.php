...
return [
    ...
    'page_orientation'      => 'P', // Options: P = portrait, L = landscape, PDF_PAGE_ORIENTATION (not used), 'P' by TCPDF-constructor
    ...
    // tcpdf-import settings, used by tcpdf-import but not by TCPDF if indicated
    ...
    // default see vendor/tecnickcom/tcpdf/tcpdf_autoconfig.php and vendor/tecnickcom/tcpdf/config/tcpdf_config.php
